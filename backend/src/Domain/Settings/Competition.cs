...
public sealed class Competition : Entity
{
    ...
    public void Update(string name, string normalizedName, DateTime utcNow) { EnsureNotArchived(); Name = name; NormalizedName = normalizedName; UpdatedAtUtc = utcNow; }
    ...
    private void EnsureNotArchived() { if (IsArchived) throw new InvalidOperationException("Archived competitions cannot be updated."); }
}
