...
internal static class SettingsEndpoints
{
    public static IEndpointRouteBuilder MapSettingsEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        seasons.MapGet("", (ISettingsService service, CancellationToken ct, bool includeArchived = false) => service.ListSeasonsAsync(includeArchived, ct));
        ...
        competitions.MapGet("", (ISettingsService service, CancellationToken ct, bool includeArchived = false) => service.ListCompetitionsAsync(includeArchived, ct));
        ...
        venues.MapGet("", (ISettingsService service, CancellationToken ct, bool includeArchived = false) => service.ListVenuesAsync(includeArchived, ct));
        ...
        opponents.MapGet("", (ISettingsService service, CancellationToken ct, bool includeArchived = false) => service.ListOpponentsAsync(includeArchived, ct));
